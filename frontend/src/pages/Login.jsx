        ...
        <div className="flex justify-center items-center min-h-[80vh]">
            <div className="w-full max-w-md p-8 glass rounded-2xl">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-gray-400 mt-2 text-sm">Login to manage your water tank</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-primary hover:bg-blue-600 text-white font-semibold py-3 px-4 rounded-xl transition-all shadow-lg shadow-blue-500/30"
                    >
                        Sign In
                    </button>
                </form>
